...
class Doctors extends Model
{
    ...
    protected $appends = ['display_picture_radius'];

    public function getDisplayPictureRadiusAttribute()
    {
        return $this->imageCreateCorners($this->display_picture, 100);
    }
    ...
    function imageCreateCorners($sourceImageFile, $radius = 20)
    {
        return 'yes';
        # test source image
        $sourceImageFile = public_path('storage/' . $sourceImageFile);
